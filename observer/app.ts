import { ConcreteSubject } from './concreteSub';
import { ConcreteObserver } from './concreteObs';

// Create a subject
const subject = new ConcreteSubject();

// Create observers
const observer1 = new ConcreteObserver(3); // top 3 scores
const observer2 = new ConcreteObserver(5); // top 5 scores
